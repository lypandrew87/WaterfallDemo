...
<form action = "viewMyItems.jsp"><input style = "color: blue; " type = "submit" name = "listitems" value = "List Items"></input></form>
<form action = "additem.jsp"><input style = "color: blue;"type = "submit" name = "additem" value = "Add Item"></form>
