...
<tr class = "table-heading"> <td> Item ID </td> <td> Item Name </td> <td> Category</td> <td> Auction Start Time<br> </td> <td> Auction End Time</td> <td> Current Bid </td><td>  </td><td>  </td>
 <%@ page import="java.util.ArrayList" %>
  ...
  String bidLow = request.getParameter("CURRENT_BID_LOWER");
  String bidUpper = request.getParameter("CURRENT_BID_UPPER");
  String timeLow = request.getParameter("AUCTION_TIME_LOWER");
  String timeUpper = request.getParameter("AUCTION_TIME_UPPER");


  ArrayList<Items> it = item.advanceSearch(itemId, keyword, category, bidLow, bidUpper, timeLow, timeUpper);  
