...
<tr class = "table-heading"> <td> Item ID </td> <td> Item Name </td> <td> Category</td> <td> Auction Start Time<br> </td> <td> Start Price</td> <td> Sold Price </td><td>Seller Username</td><td>Seller Email</td><td></td>
 <%@ page import="java.util.ArrayList" %>
  <%@ page import="amlyp.companyDB.Items" %>
  
  <%
  
  ArrayList<Items> it = item.getItemsPurchased(customer.getUserId());
